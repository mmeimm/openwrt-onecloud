...
pushd feeds/luci
    ...
    patch -p1 < 0001-luci-app-firewall-add-nft-fullcone-and-bcm-fullcone-.patch
    patch -p1 < 0002-luci-app-firewall-add-shortcut-fe-option.patch
    patch -p1 < 0003-luci-app-firewall-add-ipv6-nat-option.patch
    patch -p1 < 0004-luci-add-firewall-add-custom-nft-rule-support.patch
    patch -p1 < 0005-luci-app-firewall-add-natflow-offload-support.patch
    patch -p1 < 0006-luci-app-firewall-enable-hardware-offload-only-on-de.patch
    patch -p1 < 0007-luci-app-firewall-add-fullcone6-option-for-nftables-.patch
popd
